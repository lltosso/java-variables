public class DrivingLicense {
    ...
    public static void main(String[] args) {
        ...
        int carnet = 0 ;
        System.out.println( " Has sacado tu carnet de conducir, felicidades tienes 12 puntos " + carnet );
        // Actualiza los puntos aquí
        carnet +=  12 ;
        System.out.println( " Has sacado tu carnet de conducir, felicidades tienes 12 puntos " + carnet );
        System.out.println("Te has negado a realizar pruebas de alcohol o drogas, pierdes 6 puntos" + carnet );
        // Actualiza los puntos aquí
        carnet -= 6 ;

        System.out.println(" Has conducido con cascos o auriculares, pierdes 3 puntos " + carnet);
        // Actualiza los puntos aquí
        carnet -= 3 ;
        System.out.println("Tu coche detecta radares, pierdes 3 puntos");
        // Actualiza los puntos aquí
        carnet += 8 ;
        System.out.println("Te han retirado el carnet y ahora lo has recuperado, ganas 8 puntos" + carnet);
        // Actualiza los puntos aquí
        carnet += 8 ;
        ...
        // Actualiza los puntos aquí
        carnet += 2 ;
        System.out.println(" ¿Cuántos puntos tienes? " +carnet );
